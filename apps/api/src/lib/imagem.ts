...
export function aceitarUploadDeImagem(app: FastifyInstance) {
  app.addContentTypeParser([...IMAGEM_TIPOS], { parseAs: 'buffer', bodyLimit: IMAGEM_TAMANHO_MAXIMO }, (_req, corpo, feito) => feito(null, corpo));
}
...
export function responderImagem(req: FastifyRequest, reply: FastifyReply, imagem: ImagemGuardada | undefined, ausente: string) {
